...
<link href="static/css/style.css" rel="stylesheet">
   <!-- <link href="static/css/.css" rel="stylesheet">              addeddd  -->
<!--[if lt IE 9]>
...
.myc {
  text-align: top;
  background-image: url('static/images/homepage.avif');
  ...
  align-items: top; /* Center the content vertically */
}
.btn-delete {
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-white border-bottom">
    <a class="navbar-brand" href="/welcome"  style="color: black;">Welcome</a>
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item active"><a class="nav-link"  style="color: black;" href="/login">Login</a></li>
        <li class="nav-item"><a class="nav-link"  style="color: black;"  href="/register">New Registration</a></li>
        <li class="nav-item"><a class="nav-link"  style="color: black;"  href="/show-users">Patients</a></li>
      </ul>
    </div>
  </nav>
</div>
	...
	<c:choose>
		...
		<c:when test="${mode=='MODE_REGISTER'}">
			<div class="container regi text-center">
  ...
  <a href="/delete-user?id=${user.id }">
    <button type="button" class="btn btn-delete">
     <img src="static/images/delete.png" alt="delete Icon" class="icon">
    Delete</button>
  </a>
</td>
<td>
   <a href="/edit-user?id=${user.id}">
    <button type="button" class="btn btn-edit">
      <img src="static/images/edit.gif" alt="Edit Icon" class="icon">
      Edit
    </button>
  </a>
</td>
